...
import { BettingPanel } from '@/components/casino/BettingPanel';
import { MyBetsPanel } from '@/components/casino/MyBetsPanel';
  ...
  return (
    <DashboardLayout>
      <div className="flex h-full flex-col gap-6 lg:flex-row">
        ...
        {/* ── Right Column: Betting + My Bets + Previous Winner ── */}
        <div className="flex w-full flex-col gap-4 lg:w-1/3">
          ...
          <div className="rounded-xl border border-border bg-background-secondary p-5 shadow-sm">
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className={`rounded-xl px-3 py-1 text-sm font-semibold uppercase tracking-wider ${isSuspended ? 'bg-error/10 text-error' : 'bg-primary/10 text-primary'
                }`}>
                {status}
              </div>
            </div>
          ...
          {/* Betting Panel */}
          <BettingPanel cid={typeId} />

          {/* My Bets Panel */}
          <MyBetsPanel cid={typeId} />
